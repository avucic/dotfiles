...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(atom-one-dark-theme seeing-is-believing)
...
before packages are loaded."
  ...
  (setq elixir-ls-path "~/elixir-ls/release")
