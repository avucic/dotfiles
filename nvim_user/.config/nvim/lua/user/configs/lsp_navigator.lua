...
function M.config()
  ...
  navigator.setup({
    ...
    lsp = {
      ...
      sumneko_lua = {
        sumneko_root_path = vim.fn.expand("$HOME") .. "/.local/share/nvim/lsp_servers/sumneko_lua/extension/server",
        sumneko_binary = vim.fn.expand("$HOME")
          .. "/.local/share/nvim/lsp_servers/sumneko_lua/extension/server/bin/lua-language-server",
      },
      servers = { "gopls", "sumneko_lua", "solargraph", "tsserver", "html", "yamlls", "sqlls" }, -- by default empty, and it should load all LSP clients avalible based on filetype
